...
function changeSquare(){
  ...
  plus2.addEventListener('click',function(){
    apartsSquare.innerHTML=apartamenty[0].title+'<br>'+'Cena:'+' '+apartamenty[0].price+' '+'zł ';
    apartsSquare.style.marginTop='0.1%';
    apartsSquare.style.fontSize='0.9vw';
...
button2.addEventListener('click', function() {
  ...
  setTimeout(() => {
    ...
    const plus2=document.querySelector('.plus2');
    plus2.addEventListener('click', function(){
      apartsSquare.innerHTML=apartamenty[1].title+'<br>'+'Cena:'+' '+apartamenty[1].price+' '+'zł ';
      apartsSquare.style.marginTop='0.1%';
      apartsSquare.style.fontSize='0.7vw';
...
setTimeout(()=> {
  ...
  const plus3=document.querySelector('.plus3');
    plus3.addEventListener('click', function(){
      apartsSquare.innerHTML=apartamenty[2].title+'<br>'+'Cena:'+' '+apartamenty[2].price+' '+'zł ';
      apartsSquare.style.marginTop='0.1%';
      apartsSquare.style.fontSize='0.7vw';
